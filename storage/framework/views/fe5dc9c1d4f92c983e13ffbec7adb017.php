<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__("Perbarui informasi profil dan alamat email Anda.")); ?>
                ...
                <div>
                    ...
                    <?php if(session('status') === 'verification-link-sent'): ?>
                        <p class="mt-2 font-medium text-sm text-green-600 dark:text-green-400">
                            <?php echo e(__('Email verifikasi telah dikirim ulang.')); ?>
...
<?php /**PATH C:\laragon\www\PZN\gorogon\my-skripsi\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>