     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Hasil Rekomendasi Wisata (SAW)')); ?>

            </h2>
            <a href="<?php echo e(route('saw.results.analysis')); ?>" class="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded flex items-center gap-2">
                📊 Analisis Transparan
            </a>
        </div>
     <?php $__env->endSlot(); ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <?php $__currentLoopData = $criterias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-gradient-to-br <?php echo e($criteria->type === 'benefit' ? 'from-green-50 to-green-100' : 'from-red-50 to-red-100'); ?> dark:from-gray-700 dark:to-gray-600 p-4 rounded-lg">
                                    <p class="text-sm text-gray-600 dark:text-gray-300 font-semibold"><?php echo e($criteria->code); ?></p>
                                    <p class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2"><?php echo e($criteria->weight->weight ?? 'N/A'); ?></p>
                                    <p class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($criteria->name); ?></p>
                                    <span class="inline-block text-xs mt-2 px-2 py-1 rounded <?php echo e($criteria->type === 'benefit' ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'); ?>">
                                        <?php echo e($criteria->type === 'benefit' ? 'Benefit' : 'Cost'); ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="space-y-3">
                                <?php $__currentLoopData = $ranking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <a href="<?php echo e(route('saw.results.detail', $item['wisata_id'])); ?>" class="group">
                                        <div class="flex items-center gap-4 p-4 bg-gradient-to-r from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-lg hover:from-blue-50 hover:to-blue-100 dark:hover:from-gray-600 dark:hover:to-gray-700 border border-gray-200 dark:border-gray-700 transition-all">
                                            ...
                                            <div class="flex-shrink-0">
                                                <span class="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br <?php echo e($loop->first ? 'from-yellow-400 to-yellow-500' : ($loop->iteration == 2 ? 'from-gray-400 to-gray-500' : ($loop->iteration == 3 ? 'from-orange-400 to-orange-500' : 'from-blue-500 to-blue-600'))); ?> text-white rounded-full font-bold text-lg shadow-lg">
                                            ...
                                            <div class="flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden bg-gray-200 dark:bg-gray-600">
                                                <?php if($wisata && $wisata->image_url): ?>
                                                    <img src="<?php echo e($wisata->image_url); ?>" alt="<?php echo e($item['wisata_name']); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform">
                                                <?php else: ?>
                                            ...
                                            <div class="flex-shrink-0 text-right">
                                                ...
                                                <div class="text-xs text-gray-600 dark:text-gray-400 font-semibold">
                                                    <?php echo e(number_format($item['score'] * 100, 1)); ?>%
                                                </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\PZN\gorogon\my-skripsi\resources\views/saw/results/index.blade.php ENDPATH**/ ?>