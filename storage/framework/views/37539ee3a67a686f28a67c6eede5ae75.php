        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="<?php echo e(route('admin.criterias.store')); ?>" method="POST" data-loading="Membuat kriteria...">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            >
                                ...
                                <option value="benefit" <?php echo e(old('type') === 'benefit' ? 'selected' : ''); ?>>Benefit (Semakin Tinggi Semakin Baik)</option>
                                <option value="cost" <?php echo e(old('type') === 'cost' ? 'selected' : ''); ?>>Cost (Semakin Rendah Semakin Baik)</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex gap-4">
                            ...
                            <a
                                href="<?php echo e(route('admin.criterias.index')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\PZN\gorogon\my-skripsi\resources\views/admin/criterias/create.blade.php ENDPATH**/ ?>