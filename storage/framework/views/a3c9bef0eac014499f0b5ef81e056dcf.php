<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('Setelah akun Anda dihapus, semua sumber daya dan data akan dihapus secara permanen. Sebelum menghapus akun Anda, harap unduh data atau informasi apa pun yang ingin Anda simpan.')); ?>
...
<?php /**PATH C:\laragon\www\PZN\gorogon\my-skripsi\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>