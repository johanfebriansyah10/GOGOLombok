        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="<?php echo e(route('admin.wisatas.update', $wisata)); ?>" method="POST" enctype="multipart/form-data" data-loading="Memperbarui wisata...">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6">
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $wisata->category_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                ...
                                id="name"
                                name="name"
                                value="<?php echo e(old('name', $wisata->name)); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                required
                            >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea
                                ...
                                rows="4"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            ><?php echo e(old('description', $wisata->description)); ?></textarea>
                        ...
                        <div class="grid grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input
                                    ...
                                    id="location"
                                    name="location"
                                    value="<?php echo e(old('location', $wisata->location)); ?>"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required
                                >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="1" <?php echo e(old('rating', $wisata->rating) == 1 ? 'selected' : ''); ?>>1 - Buruk</option>
                                    <option value="2" <?php echo e(old('rating', $wisata->rating) == 2 ? 'selected' : ''); ?>>2 - Cukup</option>
                                    <option value="3" <?php echo e(old('rating', $wisata->rating) == 3 ? 'selected' : ''); ?>>3 - Baik</option>
                                    <option value="4" <?php echo e(old('rating', $wisata->rating) == 4 ? 'selected' : ''); ?>>4 - Sangat Baik</option>
                                    <option value="5" <?php echo e(old('rating', $wisata->rating) == 5 ? 'selected' : ''); ?>>5 - Luar Biasa</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea
                                ...
                                rows="2"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            ><?php echo e(old('address', $wisata->address)); ?></textarea>
                        ...
                        <div class="grid grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input
                                    ...
                                    name="latitude"
                                    step="0.00000001"
                                    value="<?php echo e(old('latitude', $wisata->latitude)); ?>"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="longitude"
                                    step="0.00000001"
                                    value="<?php echo e(old('longitude', $wisata->longitude)); ?>"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                >
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        step="1000"
                                        min="0"
                                        value="<?php echo e(old('ticket_price', $wisata->ticket_price)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        step="0.1"
                                        min="0"
                                        value="<?php echo e(old('distance', $wisata->distance)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        step="1"
                                        min="0"
                                        value="<?php echo e(old('facilities_count', $wisata->facilities_count)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        max="5"
                                        value="<?php echo e(old('actual_rating', $wisata->actual_rating)); ?>"
                        ...
                        <div class="mb-6">
                            ...
                            <?php if($wisata->image_url): ?>
                                <div class="mb-3">
                                    ...
                                    <img src="<?php echo e($wisata->image_url); ?>" alt="<?php echo e($wisata->name); ?>" class="w-40 h-40 object-cover rounded">
                                </div>
                            <?php endif; ?>
                            <input
                                type="file"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\PZN\gorogon\my-skripsi\resources\views/admin/wisatas/edit.blade.php ENDPATH**/ ?>